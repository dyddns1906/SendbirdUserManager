...
open class UserManagerBaseTests: XCTestCase {
    open func userManagerType() -> SBUserManager.Type! {
        return SBUserService.self
    }
    
    public let applicationId = "EC9D0574-E21D-45C6-B5A9-BD68B622D29E"
    public let apiToken = "2bca1a79d2b4d89baac2fcf7c82abaa84b273636"
...
//                                XCTAssertEqual(users.count, 1)
    ...
    public func testRateLimitUpdateUser() {
        ...
        for i in 0..<11 {
            let updateParams = UserUpdateParams(userId: "user\(i)", nickname: "NewNick", profileURL: nil)
            dispatchGroup.enter()
